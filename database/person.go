...
type personalData struct {
	DocumentID  *primitive.ObjectID `bson:"_id"` // as *primitive.ObjectID
...
func (m *mongodatabase) SelectOne(ctx context.Context, key, value string) (result *personalData, err error) {
